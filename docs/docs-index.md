...
## 📋 Specifications (명세서)
- [Project Spec v1.2](specifications/spec-v1.2.md): 현재 개발 중인 v1.2 명세서
...
### Development Logs
- [Dev Log v1.2](logs/dev-log-v1.2.md): v1.2 개발 과정 기록 (진행 중)
...
## 🚀 Planning (계획)
- [Roadmap](guides/roadmap.md): 차기 버전 로드맵 및 기능 목록
- [Development Method](guides/dev-method.md): 개발 방법론 및 배포 주의사항 (Lessons Learned)

---

## ☁️ Deployment (배포)
- [Fly.io 배포 가이드](guides/deploy-flyio.md): 외부 서버 배포 및 보안 설정 가이드
